/**
 * V2 runtime safe-filesystem helper for the opencode-memory plugin.
 *
 * Semantically identical to the V1 reference (`../memory-safe-fs.mjs`): every
 ...
 * durable and no-clobber. `server.mjs` never touches the filesystem directly.
 */
